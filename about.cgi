...
print ui_table_row("Version:", $text{'index_version'});
print ui_table_row("GitHub:", "<a href='https://github.com/karmantyu/zfsmanager' target='_blank'>https://github.com/karmantyu/zfsmanager</a>");
